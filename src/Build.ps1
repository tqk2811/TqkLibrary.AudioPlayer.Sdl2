...
[System.IO.File]::WriteAllText("$root\TqkLibrary.AudioPlayer.Sdl2.Native\version.generated.h", $header + "`r`n", (New-Object System.Text.UTF8Encoding($false)))
...
$nativeProj = "$root\TqkLibrary.AudioPlayer.Sdl2.Native\TqkLibrary.AudioPlayer.Sdl2.Native.vcxproj"
...
dotnet pack .\TqkLibrary.AudioPlayer.Sdl2\TqkLibrary.AudioPlayer.Sdl2.csproj -c Release -o .\TqkLibrary.AudioPlayer.Sdl2\bin\Release
if ($LASTEXITCODE -ne 0) { throw "dotnet pack failed" }
$nupkg = Get-ChildItem .\TqkLibrary.AudioPlayer.Sdl2\bin\Release\*.nupkg | Select-Object -First 1
